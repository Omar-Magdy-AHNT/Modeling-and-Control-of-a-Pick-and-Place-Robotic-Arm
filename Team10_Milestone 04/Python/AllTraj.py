...
from funcs import joint_traj, inverse_pos_kinematics_func, EEF_Pos_and_DH
...
'''
print("Joint angles (in degrees) for INITIAL position:")
print((q_req_init))
print("-------------------------------------------------")
print("Joint angles (in degrees) for MIDDLE position:")
print((q_req_mid))
print("-------------------------------------------------")
print("Joint angles (in degrees) for FINAL position:")
print((q_req_fin))
print("-------------------------------------------------")
print("-------------------------------------------------")
print("-------------------------------------------------")
