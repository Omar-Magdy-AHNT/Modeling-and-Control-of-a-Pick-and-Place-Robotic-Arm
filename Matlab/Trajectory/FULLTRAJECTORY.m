...
% figure;
% plot(time0, (Joint_Space0(:,4:6)));
% xlabel('Time [s]');
% ylabel('EEF Position 1 [m]');
% legend('x', 'y', ' z');
% title('EEF Trajectory');
% grid on;
% 
% figure;
% plot(time1, (Joint_Space1(:,4:6)));
% xlabel('Time [s]');
% ylabel('EEF Position 2 [m]');
% legend('x', 'y', ' z');
% title('EEF Trajectory');
% grid on;
% 
% figure;
% plot(time2, (Joint_Space2(:,4:6)));
% xlabel('Time [s]');
% ylabel('EEF Position 3 [m]');
% legend('x', 'y', ' z');
% title('EEF Trajectory');
% grid on;
% 
% figure;
% plot(time3, (Joint_Space3(:,4:6)));
% xlabel('Time [s]');
% ylabel('EEF Position 4 [m]');
% legend('x', 'y', ' z');
% title('EEF Trajectory');
% grid on;
% 
